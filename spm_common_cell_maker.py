...
#read the files 
root_path = '/Users/alex/brain_data/AD_DECODE/' +contrast+ '_zscored_u/smoothed/'
...
#read master sheet  
master_sheet_path = '/Users/alex/brain_data/AD_DECODE/AD_DECODE_data_short.xlsx'
...
myfile = open('/Users/alex/brain_data/AD_DECODE/'+contrast+'_cell_mspm.txt', 'w')       
...
myfile = open('/Users/alex/brain_data/AD_DECODE/'+contrast+'_age_mspm.txt', 'w')       
